...
namespace MediaInfoKeeper.Provider {
    ...
    public sealed class ItemAddedMediaInfoProvider :
        ...
        IHasOrder {
        public const string ProviderName = "MediaInfoKeeper 入库提取媒体信息";
        public const int DefaultOrder = int.MaxValue - 3;
        ...
        Task<MetadataResult<Movie>> ILocalMetadataProvider<Movie>.GetMetadata(
            ItemInfo info, LibraryOptions libraryOptions, IDirectoryService directoryService,
